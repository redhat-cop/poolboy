  ...
  <table>
    ...
    <tbody>
      <tr v-for="resourcehandle in resourcehandles" v-bind:key="resourcehandle.metadata.uid">
        ...
        <td v-if="resourcehandle.spec.resourcePool"><router-link :to="'/resourcepool/' + resourcehandle.spec.resourcePool.namespace + '/' + resourcehandle.spec.resourcePool.name">{{resourcehandle.spec.resourcePool.name}}</router-link></td>
        <td v-else>none</td>
        <td v-if="resourcehandle.spec.resourceClaim"><router-link :to="'/resourceclaim/' + resourcehandle.spec.resourceClaim.namespace + '/' + resourcehandle.spec.resourceClaim.name">{{resourcehandle.spec.resourceClaim.namespace}}/{{resourcehandle.spec.resourceClaim.name}}</router-link></td>
        <td v-else>none</td>
