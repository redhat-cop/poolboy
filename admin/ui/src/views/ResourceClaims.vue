  ...
  <table>
    ...
    <tbody>
      <tr v-for="resourceclaim in resourceclaims" v-bind:key="resourceclaim.metadata.uid">
        ...
        <td>
          <router-link :to="'/resourceclaim/' + resourceclaim.metadata.namespace + '/' + resourceclaim.metadata.name">{{resourceclaim.metadata.name}}</router-link>
        </td>
        <td v-if="resourceclaim.status && resourceclaim.status.resourceHandle">
          <router-link :to="'/resourcehandle/' + resourceclaim.status.resourceHandle.namespace + '/' + resourceclaim.status.resourceHandle.name">{{resourceclaim.status.resourceHandle.name}}</router-link>
        </td>
        <td v-else></td>
